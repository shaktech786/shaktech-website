...
const ContactPage = () => {
  ...
  if (submitted) {
    return (
      <main className="min-h-screen pt-16 bg-primary-950 flex items-center justify-center">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="w-20 h-20 bg-gradient-to-br from-accent-500 to-creative-500 rounded-full flex items-center justify-center mx-auto mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                          className={`w-full px-4 py-3 bg-gray-800 border ${errors.name ? 'border-red-500' : 'border-gray-600'} rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-colors`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleInputChange}
                          className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent resize-vertical"
            ...
            <div className="space-y-8">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center space-x-3 text-gray-300">
                    ...
                    <div>
                      ...
                      <a href="mailto:hi@shak-tech.com" className="text-accent-400 hover:text-accent-300 transition-colors">
                        hi@shak-tech.com
                      </a>
                    </div>
                  </div>
              ...
              <Card className="bg-gray-900 border-gray-700">
                ...
                <CardContent className="space-y-4">
                  <a
                    ...
                    className="flex items-center space-x-3 text-gray-300 hover:text-accent-400 transition-colors group"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center space-x-3 text-gray-300 hover:text-accent-400 transition-colors group"
                  >
                    <ExternalLink className="w-5 h-5 text-creative-400 flex-shrink-0" />
                    <div className="flex-1">
              ...
              {/* Calendar Booking */}
              <Card className="bg-gradient-to-br from-accent-900/20 to-creative-900/20 border-accent-700">
                <CardHeader>
                ...
                <CardContent>
                  <Button variant="outline" className="w-full border-accent-500 text-accent-400 hover:bg-accent-500 hover:text-white" asChild>
