...
export const mdxComponents = {
  ...
  code: ({ children, ...props }: MDXComponentProps) => (
    <code className="bg-gray-800 text-indigo-300 px-1.5 py-0.5 rounded text-sm" {...props}>
      {children}
    </code>
  ),
  ...
  blockquote: ({ children, ...props }: MDXComponentProps) => (
    <blockquote className="border-l-4 border-indigo-500 pl-4 my-4 italic text-gray-400" {...props}>
      {children}
    </blockquote>
  ),
