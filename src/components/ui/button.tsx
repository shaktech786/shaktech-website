  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:scale-95",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary-600 bg-transparent text-primary-300 hover:bg-primary-600 hover:text-white hover:border-primary-700",
        ...
        jazz: "bg-gradient-to-r from-primary-600 via-accent-500 to-creative-500 text-white hover:from-primary-700 hover:via-accent-600 hover:to-creative-600 shadow-lg hover:shadow-xl disabled:from-gray-600 disabled:via-gray-500 disabled:to-gray-600 btn-jazz beat-sync",
      },
      size: {
