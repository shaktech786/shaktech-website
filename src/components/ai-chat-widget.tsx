...
const AIChatWidget = () => {
  ...
  const predefinedResponses = {
    ...
    experience: "Shakeel is a Lead Software Consultant at Thoughtworks with 10+ years of experience. He's also a TEDx speaker and beatbox champion who brings creative problem-solving to technical challenges. He's led diversity programs, built AI platforms serving 1000+ users, and specializes in empathetic consulting.",
    ...
    thoughtworks: "At Thoughtworks, Shakeel leads AI-first initiatives and has received commendation from the North America CEO for successfully training 11 diverse interns with 100% full-time offer rate. He specializes in digital accelerator programs and mentoring engineering teams.",
